...
#include "ncnn_pfld68.h"

using ncnncv::NCNNPFLD68;

NCNNPFLD68::NCNNPFLD68(const std::string &_param_path,
...
void NCNNPFLD68::transform(const cv::Mat &mat, ncnn::Mat &in)
{
  cv::Mat mat_rs;
...
void NCNNPFLD68::detect(const cv::Mat &mat, types::Landmarks &landmarks)
{
  if (mat.empty()) return;
