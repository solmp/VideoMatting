...
#include "ncnn_mobilenetv2_se_68.h"

using ncnncv::NCNNMobileNetV2SE68;

NCNNMobileNetV2SE68::NCNNMobileNetV2SE68(const std::string &_param_path,
...
void NCNNMobileNetV2SE68::transform(const cv::Mat &mat, ncnn::Mat &in)
{
  cv::Mat mat_rs;
...
void NCNNMobileNetV2SE68::detect(const cv::Mat &mat, types::Landmarks &landmarks)
{
  if (mat.empty()) return;
