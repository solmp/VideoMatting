...
#include "ncnn_face_landmarks_1000.h"

using ncnncv::NCNNFaceLandmark1000;

NCNNFaceLandmark1000::NCNNFaceLandmark1000(const std::string &_param_path,
...
void NCNNFaceLandmark1000::transform(const cv::Mat &mat, ncnn::Mat &in)
{
  cv::Mat mat_rs;
...
void NCNNFaceLandmark1000::detect(const cv::Mat &mat, types::Landmarks &landmarks)
{
  if (mat.empty()) return;
